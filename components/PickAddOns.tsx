...
const PickAddOns = ({ title, text, price, pickSelected, setPickSelected }) => {
  ...
  return (
    <div
      onClick={onClick}
      className={`border ${status?"border-blue-500":"border-slate-300"} hover:border-blue-500 hover:cursor-pointer rounded-lg p-3 flex flex-row justify-between items-center`}>
